...
- [ ] Add form validation [status:: todo] [priority:: medium] [project:: Frontend]
- [x] Setup React project [status:: done] [priority:: high] [project:: Frontend]
- [ ] Style dashboard [status:: in-progress] [priority:: low] [project:: Frontend]
